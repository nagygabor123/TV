...
app.get('/videos', (req, res) => {
    connection.query('SELECT kod, nev, leiras, kep1, kep2, kep3, kep4, kep5, kep6, fokep FROM filmek', (error, results) => {//'SELECT kod, nev, leiras, kep1, kep2, kep3, kep4, kep5, kep6, fokep FROM filmek'
